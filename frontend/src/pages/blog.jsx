  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Latest news, updates, and insights from Shadow Talk." />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-slate-300 mb-8">
              Stay updated with the latest news, security insights, and privacy tips.
            </p>
          </div>
        </div>
      </section>
  ...
  return (
    <div className="bg-slate-800 rounded-lg shadow-lg border border-slate-700 overflow-hidden hover:border-purple-500/50 transition-all">
      <div className="h-48 bg-slate-700 flex items-center justify-center">
        <div className="text-slate-400">Featured Image</div>
      </div>
      <div className="p-6">
        <div className="flex justify-between items-center mb-2">
          <span className="text-xs text-purple-500 font-semibold uppercase tracking-wider">{category}</span>
