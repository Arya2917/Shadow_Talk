  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Learn about Shadow Talk's mission, team, and commitment to privacy."
        />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-slate-300 mb-8">
              Our mission is to create a digital world where privacy is not just
              a feature, but a fundamental right.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <p className="text-slate-300 mb-4">
                Shadow Talk was founded in 2023 by a group of privacy advocates
                and security experts who were concerned about the increasing
                erosion of digital privacy.
              </p>
              <p className="text-slate-300 mb-4">
                We saw a world where personal conversations were being
                monitored, data was being harvested, and privacy was becoming a
                luxury rather than a right. We decided to create a solution that
                would put control back in the hands of users.
              </p>
              <p className="text-slate-300">
                Today, Shadow Talk is used by thousands of people around the
                world who value their privacy and want to communicate freely
                without fear of surveillance or data collection.
              </p>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <TeamMember
                ...
                bio="Building efficient web applications from frontend to backend."
                image="/Arya.jpg"
              />
              ...
              <TeamMember
                name="Ankit Bugade"
                role="Full Stack Developer"
                bio="Passionate about creating complete web solutions"
                image="/ankit.jpg"
              />
              <TeamMember
                name="Pritam Jatkar"
                role="Full Stack Developer"
                bio="Crafting seamless digital experiences end-to-end."
                image="/pritam.png"
              />
            </div>
          </div>
